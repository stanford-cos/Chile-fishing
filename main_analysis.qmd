...
easter_raw <- read_csv(file.path(data_dir, 
                                  "gfw_fish_ef_easter_isl_vsl_info_2019-01-01_2023-09-12.csv")) 
...
easter_vessels <- easter_data |> 
  group_by(ssvid, imo, owner) |> 
  summarize(vessel_class = unique(best_vessel_class),
            total_fishin_hrs = sum(fishing_hours))
